...
/**
 * Clase principal que demuestra el uso del Arbol Binario de
 * Busqueda (BST) implementado manualmente.
 *
...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "1er menor: "
                        + pruebas.kEsimoMenor(1)
        );

        System.out.println(
                "3er menor: "
                        + pruebas.kEsimoMenor(3)
        );

        System.out.println(
                "5to menor: "
                        + pruebas.kEsimoMenor(5)
        );

        // E2
        System.out.println(
                "\n--- E2. Valores entre 15 y 70 ---"
        );

        pruebas.imprimirRangoOrdenado(
                15,
                70
        );
